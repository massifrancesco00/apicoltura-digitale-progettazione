...
const Home = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* Header Arnia */}
      <div style={{ marginLeft: '90px', marginTop: '25px', marginRight: '20px', background: theme.creamBg, borderRadius: '50px', padding: '10px 25px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: theme.honeyShadow, border: `2px solid ${theme.warmOrange}`, zIndex: 5 }}>
      ...
      <div style={{ padding: '30px', flex: 1, display: 'flex', flexDirection: 'column', gap: '30px', overflowY: 'auto' }}>
        
        {/* --- QUI SONO I PULSANTI ESAGONALI --- */}
        <div style={{ display: 'flex', justifyContent: 'center', gap: '25px', padding: '10px' }}>
          
          <div onClick={() => navigate('/dettaglio/umidita')} style={styles.hexIconBtn} className="hex-hover">
            <FaTint size={32} color={theme.accentBlue} />
          </div>
          
          <div onClick={() => navigate('/dettaglio/temperatura')} style={styles.hexIconBtn} className="hex-hover">
            <FaThermometerHalf size={32} color={theme.accentRed} />
          </div>
          
          <div onClick={() => navigate('/dettaglio/peso')} style={styles.hexIconBtn} className="hex-hover">
            <FaBalanceScale size={32} color={theme.warmOrange} />
          </div>
